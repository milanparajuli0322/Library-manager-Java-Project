...
{   
    ...
    public static class Book
    {
        ...
        class BorrowInfo
        {
            ...
            {
                System.out.println(
                    title + " is borrowed by " + borrowerName + ", date : " + dueDate
                );
            }
        }
    }
        ...
        if (!Books.isEmpty())
        {
            ...
            for (int i = 0; i < Books.size(); i++)
            {
                ...
                System.out.println(
                    ...
                    + "  Books available :" + b.getNumberOfBooks()
                );
            }
        }
        else
    ...
    public static void displayMembers(
        ArrayList<Member> Members, ArrayList<String> BorrowerName)
    {
        ...
        for (int i = 0; i < Members.size(); i++)
        {
            System.out.println(
                ...
                + "  Names :" + Members.get(i).getName()
                + "  Membership type :" + Members.get(i).getType()
            );
        }
        ...
        {
            percentBorrowing =
                (double) BorrowerName.size() / Members.size() * 100;

            System.out.println(
                "Percentage of members currently borrowing books :"
                + Math.round(percentBorrowing) + "%"
            );
        }
    }
        ...
        ArrayList<LocalDate> DueDates)
    {
        ...
        {
            System.out.println(
                "Borrower name :" + BorrowerName.get(i)
                + "  Borrowed book :" + BorrowerTitle.get(i)
    ...
    {   
        ...
        Privileged test = new Privileged()
        {
            @Override
            public String getPrivileges()
            {
                ...
                switch (choice)
                {
                    case 1->
                    {
                        ...
                        while (numberOfBooks == -9865)
                        {
                            ...
                            {
                                System.out.println(
                                    "Invalid input, Enter positive number only"
                                );
                                numberOfBooks = -9865;
                            }
                        }
                    ...
                    {
                        System.out.print(
                            "Enter genre to filter by (or press Enter to see all):"
                        );
                    ...
                    case 5->
                    {
                        ...
                        {
                            System.out.println(
                                "Type not available.Member not registered"
                            );
                        }
                    }
                    ...
                    case 7->
                    {
                        ...
                        System.out.print(
                            "Enter the title of book to check availability :"
                        );
                    ...
                    case 8->
                    {
                        ...
                        System.out.print(
                            "Enter the title of book to update status :"
                        );
                    ...
                    case 9->
                    {
                        ...
                        {
                            if (
                                BorrowerTitle.get(i).equals(returnBook)
                                && BorrowerName.get(i).equals(name)
                            )
                            {
